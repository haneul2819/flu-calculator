...
const pages = [
  {
    ...
    sections: [
      ...
      ['코로나19 예방접종과 함께 맞으세요', `
        ...
        <p>코로나19 무료접종은 <strong>75세 이상과 70~74세가 10월 12일(월)</strong>, <strong>65~69세가 10월 15일(목)</strong>부터예요. 면역저하자와 감염취약시설 입원·입소자는 10월 12일(월)부터예요.</p>`]
    ],
    faq: [
      ...
      ['어르신 코로나19 예방접종은 언제부터인가요?', '75세 이상과 70~74세는 2026년 10월 12일(월), 65~69세는 10월 15일(목)부터예요. 독감 백신과 함께 맞는 것을 권고해요.']
    ]
  },
  {
    slug: 'children',
    ...
    sections: [
      ['1회 접종일까, 2회 접종일까?', `
        ...
        <p>질병관리청이 인플루엔자 조기 유행에 대응해 일정을 조정하면서, <strong>1회 접종 대상의 시작일도 9월 28일에서 9월 21일로 앞당겨졌어요.</strong> (2026. 9. 16. 안내)</p>
...
<footer class="foot">
  <p>출처: 의정부시 「2026-2027절기 인플루엔자(독감) 예방접종 실시 안내」, 경기도교육청 「2026년 중고등학생 인플루엔자 예방접종 지원사업 안내」, 질병관리청 「2026-2027절기 국가예방접종사업 관련 안내」(2026. 9. 16. 일정 조정)</p>
