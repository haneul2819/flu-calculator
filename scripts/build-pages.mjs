...
const pages = [
  {
    ...
    description: '2026-2027절기 65세 이상 어르신 독감 무료 예방접종 일정. 75세 이상(1951년 이전 출생) 10월 6일, 70~74세(1952~1956년생) 10월 12일, 65~69세(1957~1961년생) 10월 15일부터 2027년 4월 30일까지. 신분증만 챙기면 전국 지정 의료기관에서 무료.',
  ...
  },
  {
    slug: 'children',
    crumb: '어린이',
    linkSub: '2회 접종 9. 21. · 1회 접종 9. 28.',
    title: '2026 어린이 독감 무료접종 일정 | 2회 9월 21일·1회 9월 28일',
    description: '2026-2027절기 어린이 독감 무료 예방접종(생후 6개월~14세, 2012.1.1.~2026.8.31. 출생). 처음 맞거나 1회만 맞은 만 9세 미만은 9월 21일부터 4주 간격 2회, 그 밖의 어린이는 9월 28일부터 1회. 2027년 4월 30일까지 전국 지정 의료기관.',
    ...
    key: [['2회 접종 대상', '만 9세 미만 · 처음이거나 1회만 접종', '9. 21.(월)'], ['1회 접종 대상', '2회 이상 접종했거나 만 9세 이상', '9. 28.(월)']],
    ...
    sections: [
      ['1회 접종일까, 2회 접종일까?', `
        <ul>
          ...
          <li><strong>1회 접종</strong>: 지금까지 2회 이상 맞았거나 만 9세 이상인 아이 → 9월 28일(월)부터</li>
        </ul>
    ...
    faq: [
      ...
      ['중학생도 어린이 무료접종인가요?', '2012년 이후에 태어난 중학생(2026년 기준 중1·중2)은 어린이 국가예방접종 대상이라 9월 28일부터 1회 맞아요.']
    ]
  },
  {
    slug: 'pregnant',
  ...
  },
  {
    ...
    faq: [
      ['중학교 1학년도 경기도교육청 독감 무료접종 대상인가요?', '2026년 기준 중1·중2(2012~2013년생)는 어린이 국가예방접종 대상이라 이 사업에서 제외돼요. 대신 9월 28일부터 어린이 무료접종으로 맞을 수 있어요.'],
  ...
  },
  {
    ...
    key: [['어린이 2회 · 임신부', '', '9. 21.(월)'], ['어린이 1회', '', '9. 28.(월)'], ['75세 이상', '', '10. 6.(화)'], ['70~74세', '', '10. 12.(월)'], ['65~69세', '', '10. 15.(목)'], ['의료취약계층', '의정부시민 15~64세', '10. 22.(목)']],
    keyNote: '모두 2027. 4. 30.(금)까지 · 인플루엔자 3가 백신 무료',
    sections: [
      ['의정부시 의료취약계층 무료접종', `
      ...
      ['대상별 준비물과 접종 기관', `
        <ul>
          ...
          <li><strong>어르신</strong> (1961. 12. 31. 이전 출생): 신분증 · 전국 지정위탁의료기관 · 코로나19와 동시 접종 권고</li>
